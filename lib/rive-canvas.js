                ...
                var Rive = (() => {
                    ...
                    return (
                        function (moduleArg = {}) {
                            ...
                            function ca() {
                                function b(h) { const g = d; c = a = 0; d = new Map; g.forEach(l => { try { l(h) } catch (k) { console.error(k) } }); this.Qa(); e && e.nb() } let a = 0, c = 0, d = new Map, e = null, f = null; this.requestAnimationFrame = function (h) { a || (a = requestAnimationFrame(b.bind(this))); const g = ++c; d.set(g, h); return g }; this.cancelAnimationFrame = function (h) { d.delete(h); a && 0 == d.size && (cancelAnimationFrame(a), a = 0) }; this.lb = function (h) {
                                    f && (document.body.remove(f), f = null); h || (f = document.createElement("div"), f.style.backgroundColor = "black", f.style.position =
                                        "fixed", f.style.right = 0, f.style.top = 0, f.style.color = "white", f.style.padding = "4px", f.innerHTML = "RIVE FPS", h = function (g) { f.innerHTML = "RIVE FPS " + g.toFixed(1) }, document.body.appendChild(f)); e = new function () { let g = 0, l = 0; this.nb = function () { var k = performance.now(); l ? (++g, k -= l, 1E3 < k && (h(1E3 * g / k), g = l = 0)) : (l = k, g = 0) } }
                                }; this.ib = function () { f && (document.body.remove(f), f = null); e = null }; this.Qa = function () { }
                            }
                            ...
                            const fa = new function () {
                                function b() {
                                    if (!a) {
                                        ...
                                        q.enableVertexAttribArray(0); q.enableVertexAttribArray(1); q.bindBuffer(q.ELEMENT_ARRAY_BUFFER, q.createBuffer()); q.uniform1i(q.getUniformLocation(t, "image"), 0); q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0); a = q
                                    } return !0
                                } let a = null, c = 0, d = 0, e = null, f = null, h = 0, g = 0; this.wb = function () { b(); return d }; this.gb = function (t) {
                                    if (!b()) return null; const v = a.createTexture(); a.bindTexture(a.TEXTURE_2D, v); a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, a.RGBA, a.UNSIGNED_BYTE, t); a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE);
                                    a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE); a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.LINEAR); 2 == c ? (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.LINEAR_MIPMAP_LINEAR), a.generateMipmap(a.TEXTURE_2D)) : a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.LINEAR); return v
                                }; const l = new ea(8), k = new ea(8), p = new ea(10), r = new ea(10); this.kb = function (t, v, q, F, I) {
                                    if (b()) {
                                        var w = l.push(t), y = k.push(v); if (a.canvas.width != w || a.canvas.height != y) a.canvas.width = w, a.canvas.height = y;
                                        a.viewport(0, y - v, t, v); a.disable(a.SCISSOR_TEST); a.clearColor(0, 0, 0, 0); a.clear(a.COLOR_BUFFER_BIT); a.enable(a.SCISSOR_TEST); q.sort((z, da) => da.Ua - z.Ua); w = p.push(F); h != w && (a.bufferData(a.ARRAY_BUFFER, 8 * w, a.DYNAMIC_DRAW), h = w); w = 0; for (var J of q) a.bufferSubData(a.ARRAY_BUFFER, w, J.Da), w += 4 * J.Da.length; console.assert(w == 4 * F); for (var P of q) a.bufferSubData(a.ARRAY_BUFFER, w, P.Xa), w += 4 * P.Xa.length; console.assert(w == 8 * F); w = r.push(I); g != w && (a.bufferData(a.ELEMENT_ARRAY_BUFFER, 2 * w, a.DYNAMIC_DRAW), g = w); J = 0; for (var W of q) a.bufferSubData(a.ELEMENT_ARRAY_BUFFER,
                                            J, W.indices), J += 2 * W.indices.length; console.assert(J == 2 * I); W = 0; P = !0; w = J = 0; for (const z of q) {
                                                z.image.za != W && (a.bindTexture(a.TEXTURE_2D, z.image.cb || null), W = z.image.za); z.zb ? (a.scissor(z.Ia, y - z.Ja - z.Pa, z.Gb, z.Pa), P = !0) : P && (a.scissor(0, y - v, t, v), P = !1); q = 2 / t; const da = -2 / v; a.uniform4f(e, z.oa[0] * q * z.va, z.oa[1] * da * z.wa, z.oa[2] * q * z.va, z.oa[3] * da * z.wa); a.uniform2f(f, z.oa[4] * q * z.va + q * (z.Ia - z.xb * z.va) - 1, z.oa[5] * da * z.wa + da * (z.Ja - z.yb * z.wa) + 1); a.vertexAttribPointer(0, 2, a.FLOAT, !1, 0, w); a.vertexAttribPointer(1, 2,
                                                    a.FLOAT, !1, 0, w + 4 * F); a.drawElements(a.TRIANGLES, z.indices.length, a.UNSIGNED_SHORT, J); w += 4 * z.Da.length; J += 2 * z.indices.length
                                            } console.assert(w == 4 * F); console.assert(J == 2 * I)
                                    }
                                }; this.canvas = function () { return b() && a.canvas }
                            };
                            m.onRuntimeInitialized = function () {
                                function b(n) {
                                    switch (n) {
                                        case k.srcOver: return "source-over"; case k.screen: return "screen"; case k.overlay: return "overlay"; case k.darken: return "darken"; case k.lighten: return "lighten"; case k.colorDodge: return "color-dodge"; case k.colorBurn: return "color-burn"; case k.hardLight: return "hard-light"; case k.softLight: return "soft-light"; case k.difference: return "difference"; case k.exclusion: return "exclusion"; case k.multiply: return "multiply"; case k.hue: return "hue"; case k.saturation: return "saturation";
                                        case k.color: return "color"; case k.luminosity: return "luminosity"
                                    }
                                ...
                                let v = 1; var q = m.RenderImage.extend("CanvasRenderImage", { __construct: function () { this.__parent.__construct.call(this); this.za = v; v = v + 1 & 2147483647 || 1 }, decode: function (n) { let u = Xa; u.total++; var D = this, B = new Image; B.src = URL.createObjectURL(new Blob([n], { type: "image/png" })); B.onload = function () { D.ab = B; D.cb = fa.gb(B); D.size(B.width, B.height); u.loaded++; if (u.loaded === u.total) { const E = u.ready; E && (E(), u.ready = null) } } } }), F = e.extend("CanvasRenderPath", {
                                    ...
                                    color: function (n) { this.Ha = a(n) }, thickness: function (n) {
                                        this.eb =
                                        n
                                    }, join: function (n) { switch (n) { case l.miter: this.ya = "miter"; break; case l.round: this.ya = "round"; break; case l.bevel: this.ya = "bevel" } }, cap: function (n) { switch (n) { case g.butt: this.xa = "butt"; break; case g.round: this.xa = "round"; break; case g.square: this.xa = "square" } }, style: function (n) { this.bb = n }, blendMode: function (n) { this.$a = b(n) }, clearGradient: function () { this.qa = null }, linearGradient: function (n, u, D, B) { this.qa = { Va: n, Wa: u, La: D, Ma: B, Ca: [] } }, radialGradient: function (n, u, D, B) { this.qa = { Va: n, Wa: u, La: D, Ma: B, Ca: [], ub: !0 } },
                                    addStop: function (n, u) { this.qa.Ca.push({ color: n, stop: u }) }, completeGradient: function () { }, draw: function (n, u, D) {
                                        let B = this.bb; var E = this.Ha, G = this.qa; n.globalCompositeOperation = this.$a; if (null != G) { E = G.Va; var A = G.Wa; const R = G.La; var C = G.Ma; const K = G.Ca; G.ub ? (G = R - E, C -= A, E = n.createRadialGradient(E, A, 0, E, A, Math.sqrt(G * G + C * C))) : E = n.createLinearGradient(E, A, R, C); for (let T = 0, M = K.length; T < M; T++)A = K[T], E.addColorStop(A.stop, a(A.color)); this.Ha = E; this.qa = null } switch (B) {
                                            case r: n.strokeStyle = E; n.lineWidth = this.eb;
                                                n.lineCap = this.xa; n.lineJoin = this.ya; n.stroke(u); break; case p: n.fillStyle = E, n.fill(u, D)
                                        }
                                    }
                                }); const w = new Set; let y = null, J = [], P = 0, W = 0; var z = m.CanvasRenderer = h.extend("Renderer", {
                                    __construct: function (n) { this.__parent.__construct.call(this); this.ha = [1, 0, 0, 1, 0, 0]; this.ba = n.getContext("2d"); this.Fa = n; this.da = [] }, save: function () { this.ha.push(...this.ha.slice(this.ha.length - 6)); this.da.push(this.ba.save.bind(this.ba)) }, restore: function () {
                                        const n = this.ha.length - 6; if (6 > n) throw "restore() called without matching save().";
                                        this.ha.splice(n); this.da.push(this.ba.restore.bind(this.ba))
                                    }, transform: function (n, u, D, B, E, G) { const A = this.ha, C = A.length - 6; A.splice(C, 6, A[C] * n + A[C + 2] * u, A[C + 1] * n + A[C + 3] * u, A[C] * D + A[C + 2] * B, A[C + 1] * D + A[C + 3] * B, A[C] * E + A[C + 2] * G + A[C + 4], A[C + 1] * E + A[C + 3] * G + A[C + 5]); this.da.push(this.ba.transform.bind(this.ba, n, u, D, B, E, G)) }, rotate: function (n) { const u = Math.sin(n); n = Math.cos(n); this.transform(n, u, -u, n, 0, 0) }, _drawPath: function (n, u) { this.da.push(u.draw.bind(u, this.ba, n.ia, n.Ga === t ? "evenodd" : "nonzero")) }, drawImage: function (n,
                                        ...u) { var D = this.ba; this.da.push(function () { D.drawImage(n, ...u) }) }, _drawRiveImage: function (n, u, D) { var B = n.ab; if (B) { var E = this.ba, G = b(u); this.da.push(function () { E.globalCompositeOperation = G; E.globalAlpha = D; E.drawImage(B, 0, 0); E.globalAlpha = 1 }) } }, _getMatrix: function (n) { const u = this.ha, D = u.length - 6; for (let B = 0; 6 > B; ++B)n[B] = u[D + B] }, _drawImageMesh: function (n, u, D, B, E, G, A, C, R, K) {
                                            var T = this.ba.canvas.width, M = this.ba.canvas.height; const pb = R - A, qb = K - C; A = Math.max(A, 0); C = Math.max(C, 0); R = Math.min(R, T); K = Math.min(K,
                                                M); const ua = R - A, va = K - C; console.assert(ua <= Math.min(pb, T)); console.assert(va <= Math.min(qb, M)); if (!(0 >= ua || 0 >= va)) {
                                                    R = ua < pb || va < qb; T = K = 1; var ia = Math.ceil(ua * K), ja = Math.ceil(va * T); M = fa.wb(); ia > M && (K *= M / ia, ia = M); ja > M && (T *= M / ja, ja = M); y || (y = new m.DynamicRectanizer(M), y.reset(512, 512)); M = y.addRect(ia, ja); 0 > M && (c(), w.add(this), M = y.addRect(ia, ja), console.assert(0 <= M)); var rb = M & 65535, sb = M >> 16; J.push({
                                                        oa: this.ha.slice(this.ha.length - 6), image: n, Ia: rb, Ja: sb, xb: A, yb: C, Gb: ia, Pa: ja, va: K, wa: T, Da: new Float32Array(B),
                                                        Xa: new Float32Array(E), indices: new Uint16Array(G), zb: R, Ua: n.za << 1 | (R ? 1 : 0)
                                                    }); P += B.length; W += G.length; var na = this.ba, cc = b(u); this.da.push(function () { na.save(); na.resetTransform(); na.globalCompositeOperation = cc; na.globalAlpha = D; na.drawImage(fa.canvas(), rb, sb, ia, ja, A, C, ua, va); na.restore() })
                                                }
                                        }, _clipPath: function (n) { this.da.push(this.ba.clip.bind(this.ba, n.ia, n.Ga === t ? "evenodd" : "nonzero")) }, clear: function () { w.add(this); this.da.push(this.ba.clearRect.bind(this.ba, 0, 0, this.Fa.width, this.Fa.height)) }, flush: function () { },
                                    translate: function (n, u) { this.transform(1, 0, 0, 1, n, u) }
                                }); m.makeRenderer = function (n) { return new z(n) }; m.renderFactory = { makeRenderPaint: function () { return new I }, makeRenderPath: function () { return new F }, makeRenderImage: function () { return new q } }; let da = m.load, Xa = null; m.load = function (n) { return new Promise(function (u) { let D = null; Xa = { total: 0, loaded: 0, ready: function () { u(D) } }; D = da(n); 0 == Xa.total && u(D) }) }; d = new ca; m.requestAnimationFrame = d.requestAnimationFrame.bind(d); m.cancelAnimationFrame = d.cancelAnimationFrame.bind(d);
                                m.enableFPSCounter = d.lb.bind(d); m.disableFPSCounter = d.ib; d.Qa = c; m.cleanup = function () { y && y.delete() }
                            }; var ha = Object.assign({}, m), ka = "./this.program", la = "object" == typeof window, ma = "function" == typeof importScripts, x = "", oa, pa;
                            if (la || ma) ma ? x = self.location.href : "undefined" != typeof document && document.currentScript && (x = document.currentScript.src), _scriptDir && (x = _scriptDir), 0 !== x.indexOf("blob:") ? x = x.substr(0, x.replace(/[?#].*/, "").lastIndexOf("/") + 1) : x = "", ma && (pa = b => { var a = new XMLHttpRequest; a.open("GET", b, !1); a.responseType = "arraybuffer"; a.send(null); return new Uint8Array(a.response) }), oa = (b, a, c) => {
                                var d = new XMLHttpRequest; d.open("GET", b, !0); d.responseType = "arraybuffer"; d.onload = () => {
                                    200 == d.status || 0 == d.status && d.response ?
                                    a(d.response) : c()
                                }; d.onerror = c; d.send(null)
                            }; var qa = m.print || console.log.bind(console), ra = m.printErr || console.error.bind(console); Object.assign(m, ha); ha = null; m.thisProgram && (ka = m.thisProgram); var sa; m.wasmBinary && (sa = m.wasmBinary); var noExitRuntime = m.noExitRuntime || !0; "object" != typeof WebAssembly && ta("no native wasm support detected"); var wa, H, xa = !1, ya, L, za, Aa, Ba, N, Ca, Da;
                            ...
                            function Wb(b, a, c, d, e) {
                                var f = a.length; 2 > f && Q("argTypes array size mismatch! Must at least get return value and 'this' types!"); var h = null !== a[1] && null !== c, g = !1; for (c = 1; c < a.length; ++c)if (null !== a[c] && void 0 === a[c].ea) { g = !0; break } var l = "void" !== a[0].name, k = f - 2, p = Array(k), r = [], t = []; return function () {
                                    arguments.length !== k && Q(`function ${b} called with ${arguments.length} arguments, expected ${k} args!`); t.length = 0; r.length = h ? 2 : 1; r[0] = e; if (h) { var v = a[1].toWireType(t, this); r[1] = v } for (var q = 0; q < k; ++q)p[q] =
                                        a[q + 2].toWireType(t, arguments[q]), r.push(p[q]); q = d.apply(null, r); if (g) Bb(t); else for (var F = h ? 1 : 2; F < a.length; F++) { var I = 1 === F ? v : p[F - 2]; null !== a[F].ea && a[F].ea(I) } v = l ? a[0].fromWireType(q) : void 0; return v
                                }
                            } function Xb(b, a) { for (var c = [], d = 0; d < b; d++)c.push(N[a + 4 * d >> 2]); return c }
                            ...
                            var zc = {
                                I: function (b, a, c) {
                                    b = U(b); a = lb(a, "wrapper"); c = $a(c); var d = [].slice, e = a.X, f = e.ga, h = e.$.ga, g = e.$.constructor; b = Wa(b, function () { e.$.Ra.forEach(function (k) { if (this[k] === h[k]) throw new bb(`Pure virtual function ${k} must be implemented in JavaScript`); }.bind(this)); Object.defineProperty(this, "__parent", { value: f }); this.__construct.apply(this, d.call(arguments)) }); f.__construct = function () {
                                        this === f && Q("Pass correct 'this' to __construct"); var k = g.implement.apply(void 0, [this].concat(d.call(arguments)));
                                        mb(k); var p = k.W; k.notifyOnDestruction(); p.pa = !0; Object.defineProperties(this, { W: { value: p } }); zb(this); k = p.Y; k = gb(e, k); V.hasOwnProperty(k) ? Q(`Tried to register registered instance: ${k}`) : V[k] = this
                                    }; f.__destruct = function () { this === f && Q("Pass correct 'this' to __destruct"); mb(this); var k = this.W.Y; k = gb(e, k); V.hasOwnProperty(k) ? delete V[k] : Q(`Tried to unregister unregistered instance: ${k}`) }; b.prototype = Object.create(f); for (var l in c) b.prototype[l] = c[l]; return S(b)
                                }, L: function (b) {
                                    var a = Ab[b]; delete Ab[b];
                                    var c = a.Ba, d = a.ka, e = a.Na, f = e.map(h => h.sb).concat(e.map(h => h.Db)); X([b], f, h => {
                                        var g = {}; e.forEach((l, k) => { var p = h[k], r = l.qb, t = l.rb, v = h[k + e.length], q = l.Cb, F = l.Eb; g[l.mb] = { read: I => p.fromWireType(r(t, I)), write: (I, w) => { var y = []; q(F, I, v.toWireType(y, w)); Bb(y) } } }); return [{
                                            name: a.name, fromWireType: function (l) { var k = {}, p; for (p in g) k[p] = g[p].read(l); d(l); return k }, toWireType: function (l, k) {
                                                for (var p in g) if (!(p in k)) throw new TypeError(`Missing field: "${p}"`); var r = c(); for (p in g) g[p].write(r, k[p]); null !==
                                                    l && l.push(d, r); return r
                                            }, argPackAdvance: 8, readValueFromPointer: Cb, ea: d
                                        }]
                                    })
                                }, z: function () { }, G: function (b, a, c, d, e) { var f = Fb(c); a = U(a); Y(b, { name: a, fromWireType: function (h) { return !!h }, toWireType: function (h, g) { return g ? d : e }, argPackAdvance: 8, readValueFromPointer: function (h) { if (1 === c) var g = ya; else if (2 === c) g = za; else if (4 === c) g = Ba; else throw new TypeError("Unknown boolean type size: " + a); return this.fromWireType(g[h >> f]) }, ea: null }) }, e: function (b, a, c, d, e, f, h, g, l, k, p, r, t) {
                                    p = U(p); f = Z(e, f); g && (g = Z(h, g)); k && (k =
                                        Z(l, k)); t = Z(r, t); var v = Va(p); Kb(v, function () { Vb(`Cannot construct ${p} due to unbound types`, [d]) }); X([b, a, c], d ? [d] : [], function (q) {
                                            q = q[0]; if (d) { var F = q.X; var I = F.ga } else I = Ib.prototype; q = Wa(v, function () {
                                            ...
                                            }); var w = Object.create(I, { constructor: { value: q } }); q.prototype = w; var y = new Lb(p, q, w, t, F, f, g, k); y.$ && (void 0 === y.$.sa && (y.$.sa = []), y.$.sa.push(y)); F = new Rb(p, y, !0, !1); I = new Rb(p + "*", y, !1, !1); var J = new Rb(p + " const*", y, !1, !0); ub[b] = { pointerType: I, fb: J }; Sb(v, q); return [F, I, J]
                                        })
                                }, k: function (b, a, c, d, e, f, h) {
                                    var g = Xb(c, d); a = U(a); f = Z(e, f); X([], [b], function (l) {
                                        function k() { Vb(`Cannot call ${p} due to unbound types`, g) } l = l[0]; var p = `${l.name}.${a}`; a.startsWith("@@") && (a = Symbol[a.substring(2)]);
                                        var r = l.X.constructor; void 0 === r[a] ? (k.ma = c - 1, r[a] = k) : (Jb(r, a, p), r[a].aa[c - 1] = k); X([], g, function (t) { t = Wb(p, [t[0], null].concat(t.slice(1)), null, f, h); void 0 === r[a].aa ? (t.ma = c - 1, r[a] = t) : r[a].aa[c - 1] = t; if (l.X.sa) for (const v of l.X.sa) v.constructor.hasOwnProperty(a) || (v.constructor[a] = t); return [] }); return []
                                    })
                                }, s: function (b, a, c, d, e, f, h, g) {
                                    a = U(a); f = Z(e, f); X([], [b], function (l) {
                                        l = l[0]; var k = `${l.name}.${a}`, p = { get() { Vb(`Cannot access ${k} due to unbound types`, [c]) }, enumerable: !0, configurable: !0 }; p.set = g ?
                                            () => { Vb(`Cannot access ${k} due to unbound types`, [c]) } : () => { Q(`${k} is a read-only property`) }; Object.defineProperty(l.X.constructor, a, p); X([], [c], function (r) { r = r[0]; var t = { get() { return r.fromWireType(f(d)) }, enumerable: !0 }; g && (g = Z(h, g), t.set = v => { var q = []; g(d, r.toWireType(q, v)); Bb(q) }); Object.defineProperty(l.X.constructor, a, t); return [] }); return []
                                    })
                                }, o: function (b, a, c, d, e, f) {
                                    var h = Xb(a, c); e = Z(d, e); X([], [b], function (g) {
                                        g = g[0]; var l = `constructor ${g.name}`; void 0 === g.X.la && (g.X.la = []); if (void 0 !== g.X.la[a -
                                            1]) throw new Za(`Cannot register multiple constructors with identical number of parameters (${a - 1}) for class '${g.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`); g.X.la[a - 1] = () => { Vb(`Cannot construct ${g.name} due to unbound types`, h) }; X([], h, function (k) { k.splice(1, 0, null); g.X.la[a - 1] = Wb(l, k, null, e, f); return [] }); return []
                                    })
                                }, a: function (b, a, c, d, e, f, h, g) {
                                    var l = Xb(c, d); a = U(a); f = Z(e, f); X([], [b], function (k) {
                                        function p() {
                                            Vb(`Cannot call ${r} due to unbound types`,
                                                l)
                                        } k = k[0]; var r = `${k.name}.${a}`; a.startsWith("@@") && (a = Symbol[a.substring(2)]); g && k.X.Ra.push(a); var t = k.X.ga, v = t[a]; void 0 === v || void 0 === v.aa && v.className !== k.name && v.ma === c - 2 ? (p.ma = c - 2, p.className = k.name, t[a] = p) : (Jb(t, a, r), t[a].aa[c - 2] = p); X([], l, function (q) { q = Wb(r, q, k, f, h); void 0 === t[a].aa ? (q.ma = c - 2, t[a] = q) : t[a].aa[c - 2] = q; return [] }); return []
                                    })
                                }, d: function (b, a, c, d, e, f, h, g, l, k) {
                                    a = U(a); e = Z(d, e); X([], [b], function (p) {
                                        p = p[0]; var r = `${p.name}.${a}`, t = {
                                            get() {
                                                Vb(`Cannot access ${r} due to unbound types`,
                                                    [c, h])
                                            }, enumerable: !0, configurable: !0
                                        }; t.set = l ? () => { Vb(`Cannot access ${r} due to unbound types`, [c, h]) } : () => { Q(r + " is a read-only property") }; Object.defineProperty(p.X.ga, a, t); X([], l ? [c, h] : [c], function (v) { var q = v[0], F = { get() { var w = Yb(this, p, r + " getter"); return q.fromWireType(e(f, w)) }, enumerable: !0 }; if (l) { l = Z(g, l); var I = v[1]; F.set = function (w) { var y = Yb(this, p, r + " setter"), J = []; l(k, y, I.toWireType(J, w)); Bb(J) } } Object.defineProperty(p.X.ga, a, F); return [] }); return []
                                    })
                                }, F: function (b, a) {
                                    a = U(a); Y(b, {
                                        name: a,
                                        fromWireType: function (c) { var d = $a(c); Zb(c); return d }, toWireType: function (c, d) { return S(d) }, argPackAdvance: 8, readValueFromPointer: Cb, ea: null
                                    })
                                }, l: function (b, a, c, d) { function e() { } c = Fb(c); a = U(a); e.values = {}; Y(b, { name: a, constructor: e, fromWireType: function (f) { return this.constructor.values[f] }, toWireType: function (f, h) { return h.value }, argPackAdvance: 8, readValueFromPointer: $b(a, c, d), ea: null }); Kb(a, e) }, c: function (b, a, c) {
                                    var d = lb(b, "enum"); a = U(a); b = d.constructor; d = Object.create(d.constructor.prototype, {
                                        value: { value: c },
                                        constructor: { value: Wa(`${d.name}_${a}`, function () { }) }
                                    }); b.values[c] = d; b[a] = d
                                }, u: function (b, a, c) { c = Fb(c); a = U(a); Y(b, { name: a, fromWireType: function (d) { return d }, toWireType: function (d, e) { return e }, argPackAdvance: 8, readValueFromPointer: ac(a, c), ea: null }) }, q: function (b, a, c, d, e, f) { var h = Xb(a, c); b = U(b); e = Z(d, e); Kb(b, function () { Vb(`Cannot call ${b} due to unbound types`, h) }, a - 1); X([], h, function (g) { Sb(b, Wb(b, [g[0], null].concat(g.slice(1)), null, e, f), a - 1); return [] }) }, j: function (b, a, c, d, e) {
                                    a = U(a); -1 === e && (e = 4294967295);
                                    e = Fb(c); var f = g => g; if (0 === d) { var h = 32 - 8 * c; f = g => g << h >>> h } c = a.includes("unsigned") ? function (g, l) { return l >>> 0 } : function (g, l) { return l }; Y(b, { name: a, fromWireType: f, toWireType: c, argPackAdvance: 8, readValueFromPointer: bc(a, e, 0 !== d), ea: null })
                                }, g: function (b, a, c) { function d(f) { f >>= 2; var h = N; return new e(h.buffer, h[f + 1], h[f]) } var e = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][a]; c = U(c); Y(b, { name: c, fromWireType: d, argPackAdvance: 8, readValueFromPointer: d }, { tb: !0 }) },
                                v: function (b, a) {
                                    a = U(a); var c = "std::string" === a; Y(b, {
                                        name: a, fromWireType: function (d) { var e = N[d >> 2], f = d + 4; if (c) for (var h = f, g = 0; g <= e; ++g) { var l = f + g; if (g == e || 0 == L[l]) { h = h ? ec(L, h, l - h) : ""; if (void 0 === k) var k = h; else k += String.fromCharCode(0), k += h; h = l + 1 } } else { k = Array(e); for (g = 0; g < e; ++g)k[g] = String.fromCharCode(L[f + g]); k = k.join("") } kb(d); return k }, toWireType: function (d, e) {
                                            e instanceof ArrayBuffer && (e = new Uint8Array(e)); var f, h = "string" == typeof e; h || e instanceof Uint8Array || e instanceof Uint8ClampedArray ||
                                                e instanceof Int8Array || Q("Cannot pass non-string to std::string"); var g; if (c && h) for (f = g = 0; f < e.length; ++f) { var l = e.charCodeAt(f); 127 >= l ? g++ : 2047 >= l ? g += 2 : 55296 <= l && 57343 >= l ? (g += 4, ++f) : g += 3 } else g = e.length; f = g; g = yc(4 + f + 1); l = g + 4; N[g >> 2] = f; if (c && h) {
                                                    if (h = l, l = f + 1, f = L, 0 < l) {
                                                        l = h + l - 1; for (var k = 0; k < e.length; ++k) {
                                                            var p = e.charCodeAt(k); if (55296 <= p && 57343 >= p) { var r = e.charCodeAt(++k); p = 65536 + ((p & 1023) << 10) | r & 1023 } if (127 >= p) { if (h >= l) break; f[h++] = p } else {
                                                                if (2047 >= p) { if (h + 1 >= l) break; f[h++] = 192 | p >> 6 } else {
                                                                    if (65535 >= p) {
                                                                        if (h +
                                                                            2 >= l) break; f[h++] = 224 | p >> 12
                                                                    } else { if (h + 3 >= l) break; f[h++] = 240 | p >> 18; f[h++] = 128 | p >> 12 & 63 } f[h++] = 128 | p >> 6 & 63
                                                                } f[h++] = 128 | p & 63
                                                            }
                                                        } f[h] = 0
                                                    }
                                                } else if (h) for (h = 0; h < f; ++h)k = e.charCodeAt(h), 255 < k && (kb(l), Q("String has UTF-16 code units that do not fit in 8 bits")), L[l + h] = k; else for (h = 0; h < f; ++h)L[l + h] = e[h]; null !== d && d.push(kb, g); return g
                                        }, argPackAdvance: 8, readValueFromPointer: Cb, ea: function (d) { kb(d) }
                                    })
                                }, t: function (b, a, c) {
                                    c = U(c); if (2 === a) { var d = gc; var e = hc; var f = ic; var h = () => Aa; var g = 1 } else 4 === a && (d = jc, e = kc, f = lc,
                                ...
                                n: function (b) { var a = $a(b); Bb(a); Zb(b) }, x: function (b, a) { b = lb(b, "_emval_take_value"); b = b.readValueFromPointer(a); return S(b) }, b: () => { ta("") }, A: b => { var a = L.length; b >>>= 0; if (2147483648 < b) return !1; for (var c = 1; 4 >= c; c *= 2) { var d = a * (1 + .2 / c); d = Math.min(d, b + 100663296); var e = Math; d = Math.max(b, d); a: { e = e.min.call(e, 2147483648, d + (65536 - d % 65536) % 65536) - wa.buffer.byteLength + 65535 >>> 16; try { wa.grow(e); Ea(); var f = 1; break a } catch (h) { } f = void 0 } if (f) return !0 } return !1 }, B: (b, a) => {
                                    var c = 0; uc().forEach(function (d, e) {
                                        var f =
                                            a + c; e = N[b + 4 * e >> 2] = f; for (f = 0; f < d.length; ++f)ya[e++ >> 0] = d.charCodeAt(f); ya[e >> 0] = 0; c += d.length + 1
                                    }); return 0
                                }, C: (b, a) => { var c = uc(); N[b >> 2] = c.length; var d = 0; c.forEach(function (e) { d += e.length + 1 }); N[a >> 2] = d; return 0 }, D: () => 52, y: function () { return 70 }, E: (b, a, c, d) => { for (var e = 0, f = 0; f < c; f++) { var h = N[a >> 2], g = N[a + 4 >> 2]; a += 8; for (var l = 0; l < g; l++) { var k = L[h + l], p = vc[b]; 0 === k || 10 === k ? ((1 === b ? qa : ra)(ec(p, 0)), p.length = 0) : p.push(k) } e += g } N[d >> 2] = e; return 0 }
                            };
