                ...
                var Rive = (() => {
                    ...
                    return (
                        function (Rive) {
                            ...
                            function ca() {
                                function b(h) { const g = d; c = a = 0; d = new Map; g.forEach(l => { try { l(h) } catch (k) { console.error(k) } }); this.La(); e && e.fb() } let a = 0, c = 0, d = new Map, e = null, f = null; this.requestAnimationFrame = function (h) { a || (a = requestAnimationFrame(b.bind(this))); const g = ++c; d.set(g, h); return g }; this.cancelAnimationFrame = function (h) { d.delete(h); a && 0 == d.size && (cancelAnimationFrame(a), a = 0) }; this.cb = function (h) {
                                    f && (document.body.remove(f), f = null); h || (f = document.createElement("div"), f.style.backgroundColor = "black", f.style.position =
                                        "fixed", f.style.right = 0, f.style.top = 0, f.style.color = "white", f.style.padding = "4px", f.innerHTML = "RIVE FPS", h = function (g) { f.innerHTML = "RIVE FPS " + g.toFixed(1) }, document.body.appendChild(f)); e = new function () { let g = 0, l = 0; this.fb = function () { var k = performance.now(); l ? (++g, k -= l, 1E3 < k && (h(1E3 * g / k), g = l = 0)) : (l = k, g = 0) } }
                                }; this.$a = function () { f && (document.body.remove(f), f = null); e = null }; this.La = function () { }
                            }
                            ...
                            const fa = new function () {
                                ...
                                } let a = null, c = 0, d = 0, e = null, f = null, h = 0, g = 0; this.ob = function () { b(); return d }; this.Ya = function (t) {
                                ...
                                }; const l = new ea(8), k = new ea(8), p = new ea(10), r = new ea(10); this.bb = function (t, v, q, F, I) {
                                    if (b()) {
                                        var w = l.push(t), z = k.push(v); if (a.canvas.width != w || a.canvas.height != z) a.canvas.width = w, a.canvas.height = z;
                            ...
                            Rive.onRuntimeInitialized = function () {
                                function b(n) {
                                    ...
                                    t = Rive.FillRule.evenOdd; let v = 1; var q = Rive.RenderImage.extend("CanvasRenderImage", { __construct: function () { this.__parent.__construct.call(this); this.va = v; v = v + 1 & 2147483647 || 1 }, decode: function (n) { let u = Xa; u.total++; var D = this, B = new Image; B.src = URL.createObjectURL(new Blob([n], { type: "image/png" })); B.onload = function () { D.Ta = B; D.Va = fa.Ya(B); D.size(B.width, B.height); u.loaded++; if (u.loaded === u.total) { const E = u.ready; E && (E(), u.ready = null) } } } }), F = e.extend("CanvasRenderPath", {
                                        ...
                                        color: function (n) { this.Da = a(n) }, thickness: function (n) {
                                            this.Wa =
                                                n
                                        }, join: function (n) { switch (n) { case l.miter: this.ua = "miter"; break; case l.round: this.ua = "round"; break; case l.bevel: this.ua = "bevel" } }, cap: function (n) { switch (n) { case g.butt: this.ta = "butt"; break; case g.round: this.ta = "round"; break; case g.square: this.ta = "square" } }, style: function (n) { this.Ua = n }, blendMode: function (n) { this.Sa = b(n) }, linearGradient: function (n, u, D, B) { this.oa = { Pa: n, Qa: u, Ha: D, Ia: B, za: [] } }, radialGradient: function (n, u, D, B) { this.oa = { Pa: n, Qa: u, Ha: D, Ia: B, za: [], mb: !0 } }, addStop: function (n, u) {
                                            this.oa.za.push({
                                                color: n,
                                                stop: u
                                            })
                                        }, completeGradient: function () { }, draw: function (n, u, D) {
                                            let B = this.Ua; var E = this.Da, G = this.oa; n.globalCompositeOperation = this.Sa; if (null != G) { E = G.Pa; var A = G.Qa; const R = G.Ha; var C = G.Ia; const K = G.za; G.mb ? (G = R - E, C -= A, E = n.createRadialGradient(E, A, 0, E, A, Math.sqrt(G * G + C * C))) : E = n.createLinearGradient(E, A, R, C); for (let U = 0, L = K.length; U < L; U++)A = K[U], E.addColorStop(A.stop, a(A.color)); this.Da = E; this.oa = null } switch (B) {
                                                case r: n.strokeStyle = E; n.lineWidth = this.Wa; n.lineCap = this.ta; n.lineJoin = this.ua; n.stroke(u);
                                                    break; case p: n.fillStyle = E, n.fill(u, D)
                                            }
                                        }
                                    }); const w = new Set; let z = null, J = [], P = 0, X = 0; var y = Rive.CanvasRenderer = h.extend("Renderer", {
                                        __construct: function (n) { this.__parent.__construct.call(this); this.fa = [1, 0, 0, 1, 0, 0]; this.Z = n.getContext("2d"); this.Ba = n; this.ba = [] }, save: function () { this.fa.push(...this.fa.slice(this.fa.length - 6)); this.ba.push(this.Z.save.bind(this.Z)) }, restore: function () { const n = this.fa.length - 6; if (6 > n) throw "restore() called without matching save()."; this.fa.splice(n); this.ba.push(this.Z.restore.bind(this.Z)) },
                                        transform: function (n, u, D, B, E, G) { const A = this.fa, C = A.length - 6; A.splice(C, 6, A[C] * n + A[C + 2] * u, A[C + 1] * n + A[C + 3] * u, A[C] * D + A[C + 2] * B, A[C + 1] * D + A[C + 3] * B, A[C] * E + A[C + 2] * G + A[C + 4], A[C + 1] * E + A[C + 3] * G + A[C + 5]); this.ba.push(this.Z.transform.bind(this.Z, n, u, D, B, E, G)) }, rotate: function (n) { const u = Math.sin(n); n = Math.cos(n); this.transform(n, u, -u, n, 0, 0) }, _drawPath: function (n, u) { this.ba.push(u.draw.bind(u, this.Z, n.ga, n.Ca === t ? "evenodd" : "nonzero")) }, drawImage: function (n, ...u) {
                                            var D = this.Z; this.ba.push(function () {
                                                D.drawImage(n,
                                                    ...u)
                                            })
                                        }, _drawRiveImage: function (n, u, D) { var B = n.Ta; if (B) { var E = this.Z, G = b(u); this.ba.push(function () { E.globalCompositeOperation = G; E.globalAlpha = D; E.drawImage(B, 0, 0); E.globalAlpha = 1 }) } }, _getMatrix: function (n) { const u = this.fa, D = u.length - 6; for (let B = 0; 6 > B; ++B)n[B] = u[D + B] }, _drawImageMesh: function (n, u, D, B, E, G, A, C, R, K) {
                                            var U = this.Z.canvas.width, L = this.Z.canvas.height; const pb = R - A, qb = K - C; A = Math.max(A, 0); C = Math.max(C, 0); R = Math.min(R, U); K = Math.min(K, L); const sa = R - A, ta = K - C; console.assert(sa <= Math.min(pb, U));
                                            console.assert(ta <= Math.min(qb, L)); if (!(0 >= sa || 0 >= ta)) {
                                                R = sa < pb || ta < qb; U = K = 1; var ia = Math.ceil(sa * K), ja = Math.ceil(ta * U); L = fa.ob(); ia > L && (K *= L / ia, ia = L); ja > L && (U *= L / ja, ja = L); z || (z = new m.DynamicRectanizer(L), z.reset(512, 512)); L = z.addRect(ia, ja); 0 > L && (c(), w.add(this), L = z.addRect(ia, ja), console.assert(0 <= L)); var rb = L & 65535, sb = L >> 16; J.push({
                                                    la: this.fa.slice(this.fa.length - 6), image: n, Ea: rb, Fa: sb, pb: A, qb: C, yb: ia, Ka: ja, ra: K, sa: U, Aa: new Float32Array(B), Ra: new Float32Array(E), indices: new Uint16Array(G), rb: R, Oa: n.va <<
                                                        1 | (R ? 1 : 0)
                                                }); P += B.length; X += G.length; var na = this.Z, Yb = b(u); this.ba.push(function () { na.save(); na.resetTransform(); na.globalCompositeOperation = Yb; na.globalAlpha = D; na.drawImage(fa.canvas(), rb, sb, ia, ja, A, C, sa, ta); na.restore() })
                                            }
                                        }, _clipPath: function (n) { this.ba.push(this.Z.clip.bind(this.Z, n.ga, n.Ca === t ? "evenodd" : "nonzero")) }, clear: function () { w.add(this); this.ba.push(this.Z.clearRect.bind(this.Z, 0, 0, this.Ba.width, this.Ba.height)) }, flush: function () { }, translate: function (n, u) { this.transform(1, 0, 0, 1, n, u) }
                                    });
                            ...
                            function Ub(b, a, c, d, e) {
                                var f = a.length; 2 > f && Q("argTypes array size mismatch! Must at least get return value and 'this' types!"); var h = null !== a[1] && null !== c, g = !1; for (c = 1; c < a.length; ++c)if (null !== a[c] && void 0 === a[c].ca) { g = !0; break } var l = "void" !== a[0].name, k = f - 2, p = Array(k), r = [], t = []; return function () {
                                    arguments.length !== k && Q("function " + b + " called with " + arguments.length + " arguments, expected " + k + " args!"); t.length = 0; r.length = h ? 2 : 1; r[0] = e; if (h) { var v = a[1].toWireType(t, this); r[1] = v } for (var q = 0; q < k; ++q)p[q] =
                                        a[q + 2].toWireType(t, arguments[q]), r.push(p[q]); q = d.apply(null, r); if (g) Ab(t); else for (var F = h ? 1 : 2; F < a.length; F++) { var I = 1 === F ? v : p[F - 2]; null !== a[F].ca && a[F].ca(I) } v = l ? a[0].fromWireType(q) : void 0; return v
                                }
                            } function Vb(b, a) { for (var c = [], d = 0; d < b; d++)c.push(M[a + 4 * d >> 2]); return c }
                            ...
                            var sc = {
                                G: function (b, a, c) {
                                    b = T(b); a = kb(a, "wrapper"); c = $a(c); var d = [].slice, e = a.V, f = e.ea, h = e.$.ea, g = e.$.constructor; b = Va(b, function () { e.$.Ma.forEach(function (k) { if (this[k] === h[k]) throw new ab("Pure virtual function " + k + " must be implemented in JavaScript"); }.bind(this)); Object.defineProperty(this, "__parent", { value: f }); this.__construct.apply(this, d.call(arguments)) }); f.__construct = function () {
                                        this === f && Q("Pass correct 'this' to __construct"); var k = g.implement.apply(void 0, [this].concat(d.call(arguments)));
                                        lb(k); var p = k.U; k.notifyOnDestruction(); p.ma = !0; Object.defineProperties(this, { U: { value: p } }); yb(this); k = p.W; k = fb(e, k); V.hasOwnProperty(k) ? Q("Tried to register registered instance: " + k) : V[k] = this
                                    }; f.__destruct = function () { this === f && Q("Pass correct 'this' to __destruct"); lb(this); var k = this.U.W; k = fb(e, k); V.hasOwnProperty(k) ? delete V[k] : Q("Tried to unregister unregistered instance: " + k) }; b.prototype = Object.create(f); for (var l in c) b.prototype[l] = c[l]; return S(b)
                                }, J: function (b) {
                                    var a = zb[b]; delete zb[b];
                                    var c = a.xa, d = a.ha, e = a.Ja, f = e.map(h => h.kb).concat(e.map(h => h.vb)); W([b], f, h => {
                                        var g = {}; e.forEach((l, k) => { var p = h[k], r = l.ib, t = l.jb, v = h[k + e.length], q = l.ub, F = l.wb; g[l.eb] = { read: I => p.fromWireType(r(t, I)), write: (I, w) => { var z = []; q(F, I, v.toWireType(z, w)); Ab(z) } } }); return [{
                                            ...
                                            }, argPackAdvance: 8, readValueFromPointer: Bb, ca: d
                                        }]
                                    })
                                }, z: function () { }, E: function (b, a, c, d, e) { var f = Eb(c); a = T(a); Y(b, { name: a, fromWireType: function (h) { return !!h }, toWireType: function (h, g) { return g ? d : e }, argPackAdvance: 8, readValueFromPointer: function (h) { if (1 === c) var g = Aa; else if (2 === c) g = Ba; else if (4 === c) g = Da; else throw new TypeError("Unknown boolean type size: " + a); return this.fromWireType(g[h >> f]) }, ca: null }) }, e: function (b, a, c, d, e, f, h, g, l, k, p, r, t) {
                                    p = T(p); f = Z(e, f); g && (g = Z(h, g)); k && (k =
                                        Z(l, k)); t = Z(r, t); var v = Ua(p); Ib(v, function () { Tb("Cannot construct " + p + " due to unbound types", [d]) }); W([b, a, c], d ? [d] : [], function (q) {
                                            q = q[0]; if (d) { var F = q.V; var I = F.ea } else I = Gb.prototype; q = Va(v, function () {
                                                if (Object.getPrototypeOf(this) !== w) throw new Za("Use 'new' to construct " + p); if (void 0 === z.ia) throw new Za(p + " has no accessible constructor"); var P = z.ia[arguments.length]; if (void 0 === P) throw new Za("Tried to invoke ctor of " + p + " with invalid number of parameters (" + arguments.length + ") - expected (" +
                                                    Object.keys(z.ia).toString() + ") parameters instead!"); return P.apply(this, arguments)
                                            }); var w = Object.create(I, { constructor: { value: q } }); q.prototype = w; var z = new Jb(p, q, w, t, F, f, g, k); F = new Pb(p, z, !0, !1); I = new Pb(p + "*", z, !1, !1); var J = new Pb(p + " const*", z, !1, !0); tb[b] = { pointerType: I, Xa: J }; Qb(v, q); return [F, I, J]
                                        })
                                }, k: function (b, a, c, d, e, f, h) {
                                    var g = Vb(c, d); a = T(a); f = Z(e, f); W([], [b], function (l) {
                                        function k() { Tb("Cannot call " + p + " due to unbound types", g) } l = l[0]; var p = l.name + "." + a; a.startsWith("@@") && (a = Symbol[a.substring(2)]);
                                        var r = l.V.constructor; void 0 === r[a] ? (k.ja = c - 1, r[a] = k) : (Hb(r, a, p), r[a].Y[c - 1] = k); W([], g, function (t) { t = Ub(p, [t[0], null].concat(t.slice(1)), null, f, h); void 0 === r[a].Y ? (t.ja = c - 1, r[a] = t) : r[a].Y[c - 1] = t; return [] }); return []
                                    })
                                }, s: function (b, a, c, d, e, f, h, g) {
                                    a = T(a); f = Z(e, f); W([], [b], function (l) {
                                        l = l[0]; var k = l.name + "." + a, p = { get: function () { Tb("Cannot access " + k + " due to unbound types", [c]) }, enumerable: !0, configurable: !0 }; p.set = g ? () => { Tb("Cannot access " + k + " due to unbound types", [c]) } : () => { Q(k + " is a read-only property") };
                                        Object.defineProperty(l.V.constructor, a, p); W([], [c], function (r) { r = r[0]; var t = { get: function () { return r.fromWireType(f(d)) }, enumerable: !0 }; g && (g = Z(h, g), t.set = v => { var q = []; g(d, r.toWireType(q, v)); Ab(q) }); Object.defineProperty(l.V.constructor, a, t); return [] }); return []
                                    })
                                }, o: function (b, a, c, d, e, f) {
                                    0 < a || ua(); var h = Vb(a, c); e = Z(d, e); W([], [b], function (g) {
                                        g = g[0]; var l = "constructor " + g.name; void 0 === g.V.ia && (g.V.ia = []); if (void 0 !== g.V.ia[a - 1]) throw new Za("Cannot register multiple constructors with identical number of parameters (" +
                                            (a - 1) + ") for class '" + g.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!"); g.V.ia[a - 1] = () => { Tb("Cannot construct " + g.name + " due to unbound types", h) }; W([], h, function (k) { k.splice(1, 0, null); g.V.ia[a - 1] = Ub(l, k, null, e, f); return [] }); return []
                                    })
                                }, a: function (b, a, c, d, e, f, h, g) {
                                    var l = Vb(c, d); a = T(a); f = Z(e, f); W([], [b], function (k) {
                                        function p() { Tb("Cannot call " + r + " due to unbound types", l) } k = k[0]; var r = k.name + "." + a; a.startsWith("@@") && (a = Symbol[a.substring(2)]);
                                        g && k.V.Ma.push(a); var t = k.V.ea, v = t[a]; void 0 === v || void 0 === v.Y && v.className !== k.name && v.ja === c - 2 ? (p.ja = c - 2, p.className = k.name, t[a] = p) : (Hb(t, a, r), t[a].Y[c - 2] = p); W([], l, function (q) { q = Ub(r, q, k, f, h); void 0 === t[a].Y ? (q.ja = c - 2, t[a] = q) : t[a].Y[c - 2] = q; return [] }); return []
                                    })
                                }, d: function (b, a, c, d, e, f, h, g, l, k) {
                                    a = T(a); e = Z(d, e); W([], [b], function (p) {
                                        p = p[0]; var r = p.name + "." + a, t = { get: function () { Tb("Cannot access " + r + " due to unbound types", [c, h]) }, enumerable: !0, configurable: !0 }; t.set = l ? () => {
                                            Tb("Cannot access " + r + " due to unbound types",
                                                [c, h])
                                        } : () => { Q(r + " is a read-only property") }; Object.defineProperty(p.V.ea, a, t); W([], l ? [c, h] : [c], function (v) { var q = v[0], F = { get: function () { var w = Wb(this, p, r + " getter"); return q.fromWireType(e(f, w)) }, enumerable: !0 }; if (l) { l = Z(g, l); var I = v[1]; F.set = function (w) { var z = Wb(this, p, r + " setter"), J = []; l(k, z, I.toWireType(J, w)); Ab(J) } } Object.defineProperty(p.V.ea, a, F); return [] }); return []
                                    })
                                }, D: function (b, a) {
                                    a = T(a); Y(b, {
                                        name: a, fromWireType: function (c) { var d = $a(c); Xb(c); return d }, toWireType: function (c, d) { return S(d) },
                                        argPackAdvance: 8, readValueFromPointer: Bb, ca: null
                                    })
                                    ...
                                    a, c) { c = Eb(c); a = T(a); Y(b, { name: a, fromWireType: function (d) { return d }, toWireType: function (d, e) { return e }, argPackAdvance: 8, readValueFromPointer: $b(a, c), ca: null }) }, q: function (b, a, c, d, e, f) { var h = Vb(a, c); b = T(b); e = Z(d, e); Ib(b, function () { Tb("Cannot call " + b + " due to unbound types", h) }, a - 1); W([], h, function (g) { Qb(b, Ub(b, [g[0], null].concat(g.slice(1)), null, e, f), a - 1); return [] }) }, j: function (b, a, c, d, e) {
                                        a = T(a); -1 === e && (e = 4294967295); e = Eb(c); var f = g => g; if (0 === d) { var h = 32 - 8 * c; f = g => g << h >>> h } c = a.includes("unsigned") ?
                                            function (g, l) { return l >>> 0 } : function (g, l) { return l }; Y(b, { name: a, fromWireType: f, toWireType: c, argPackAdvance: 8, readValueFromPointer: ac(a, e, 0 !== d), ca: null })
                                    }, g: function (b, a, c) { function d(f) { f >>= 2; var h = M; return new e(za, h[f + 1], h[f]) } var e = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][a]; c = T(c); Y(b, { name: c, fromWireType: d, argPackAdvance: 8, readValueFromPointer: d }, { lb: !0 }) }, v: function (b, a) {
                                        a = T(a); var c = "std::string" === a; Y(b, {
                                            name: a, fromWireType: function (d) {
                                                var e =
                                                    M[d >> 2], f = d + 4; if (c) for (var h = f, g = 0; g <= e; ++g) { var l = f + g; if (g == e || 0 == H[l]) { h = h ? ya(H, h, l - h) : ""; if (void 0 === k) var k = h; else k += String.fromCharCode(0), k += h; h = l + 1 } } else { k = Array(e); for (g = 0; g < e; ++g)k[g] = String.fromCharCode(H[f + g]); k = k.join("") } jb(d); return k
                                            }, toWireType: function (d, e) {
                                                e instanceof ArrayBuffer && (e = new Uint8Array(e)); var f, h = "string" == typeof e; h || e instanceof Uint8Array || e instanceof Uint8ClampedArray || e instanceof Int8Array || Q("Cannot pass non-string to std::string"); if (c && h) {
                                                    var g = 0; for (f =
                                                        0; f < e.length; ++f) { var l = e.charCodeAt(f); 127 >= l ? g++ : 2047 >= l ? g += 2 : 55296 <= l && 57343 >= l ? (g += 4, ++f) : g += 3 } f = g
                                                } else f = e.length; g = rc(4 + f + 1); l = g + 4; M[g >> 2] = f; if (c && h) {
                                                        ...
                                                        l = h + l - 1; for (var k = 0; k < e.length; ++k) {
                                                            var p = e.charCodeAt(k); if (55296 <= p && 57343 >= p) { var r = e.charCodeAt(++k); p = 65536 + ((p & 1023) << 10) | r & 1023 } if (127 >= p) { if (h >= l) break; f[h++] = p } else {
                                                                if (2047 >= p) { if (h + 1 >= l) break; f[h++] = 192 | p >> 6 } else {
                                                                    if (65535 >= p) { if (h + 2 >= l) break; f[h++] = 224 | p >> 12 } else {
                                                                        if (h + 3 >= l) break; f[h++] = 240 | p >> 18; f[h++] = 128 | p >> 12 &
                                                                            63
                                                                    } f[h++] = 128 | p >> 6 & 63
                                                                } f[h++] = 128 | p & 63
                                                            }
                                                ...
                                                } else if (h) for (h = 0; h < f; ++h)k = e.charCodeAt(h), 255 < k && (jb(l), Q("String has UTF-16 code units that do not fit in 8 bits")), H[l + h] = k; else for (h = 0; h < f; ++h)H[l + h] = e[h]; null !== d && d.push(jb, g); return g
                                            }, argPackAdvance: 8, readValueFromPointer: Bb, ca: function (d) { jb(d) }
                                        })
                                    }, t: function (b, a, c) {
                                        c = T(c); if (2 === a) { var d = cc; var e = dc; var f = ec; var h = () => Ca; var g = 1 } else 4 === a && (d = fc, e = gc, f = hc, h = () => M, g = 2); Y(b, {
                                            name: c, fromWireType: function (l) {
                                                for (var k = M[l >> 2], p = h(), r, t = l + 4, v =
                                                    0; v <= k; ++v) { var q = l + 4 + v * a; if (v == k || 0 == p[q >> g]) t = d(t, q - t), void 0 === r ? r = t : (r += String.fromCharCode(0), r += t), t = q + a } jb(l); return r
                                            }, toWireType: function (l, k) { "string" != typeof k && Q("Cannot pass non-string to C++ string type " + c); var p = f(k), r = rc(4 + p + a); M[r >> 2] = p >> g; e(k, r + 4, p + a); null !== l && l.push(jb, r); return r }, argPackAdvance: 8, readValueFromPointer: Bb, ca: function (l) { jb(l) }
                                        })
                                    }, L: function (b, a, c, d, e, f) { zb[b] = { name: T(a), xa: Z(c, d), ha: Z(e, f), Ja: [] } }, K: function (b, a, c, d, e, f, h, g, l, k) {
                                        zb[b].Ja.push({
                                            eb: T(a), kb: c, ib: Z(d,
                                                e), jb: f, vb: h, ub: Z(g, l), wb: k
                                        })
                                    }, F: function (b, a) { a = T(a); Y(b, { nb: !0, name: a, argPackAdvance: 0, fromWireType: function () { }, toWireType: function () { } }) }, r: function (b, a, c) { b = $a(b); a = kb(a, "emval::as"); var d = [], e = S(d); M[c >> 2] = e; return a.toWireType(d, b) }, w: function (b, a, c, d, e) { b = kc[b]; a = $a(a); c = jc(c); var f = []; M[d >> 2] = S(f); return b(a, c, f, e) }, i: function (b, a, c, d) { b = kc[b]; a = $a(a); c = jc(c); b(a, c, null, d) }, f: Xb, h: function (b, a) {
                                        var c = mc(b, a), d = c[0]; a = d.name + "_$" + c.slice(1).map(function (h) { return h.name }).join("_") + "$"; var e =
                                            nc[a]; if (void 0 !== e) return e; var f = Array(b - 1); e = lc((h, g, l, k) => { for (var p = 0, r = 0; r < b - 1; ++r)f[r] = c[r + 1].readValueFromPointer(k + p), p += c[r + 1].argPackAdvance; h = h[g].apply(h, f); for (r = 0; r < b - 1; ++r)c[r + 1].Za && c[r + 1].Za(f[r]); if (!d.nb) return d.toWireType(l, h) }); return nc[a] = e
                                    }, p: function (b) { b = jc(b); return S(m[b]) }, I: function (b, a) { b = $a(b); a = $a(a); return S(b[a]) }, m: function (b) { 4 < b && (O[b].ya += 1) }, H: function (b) { return S(jc(b)) }, n: function (b) { var a = $a(b); Ab(a); Xb(b) }, x: function (b, a) {
                                        b = kb(b, "_emval_take_value"); b =
                                            b.readValueFromPointer(a); return S(b)
                                    }, b: function () { ua("") }, A: function (b) { var a = H.length; b >>>= 0; if (2147483648 < b) return !1; for (var c = 1; 4 >= c; c *= 2) { var d = a * (1 + .2 / c); d = Math.min(d, b + 100663296); var e = Math; d = Math.max(b, d); e = e.min.call(e, 2147483648, d + (65536 - d % 65536) % 65536); a: { try { va.grow(e - za.byteLength + 65535 >>> 16); Ga(); var f = 1; break a } catch (h) { } f = void 0 } if (f) return !0 } return !1 }, C: function () { return 52 }, y: function () { return 70 }, B: function (b, a, c, d) {
                                        for (var e = 0, f = 0; f < c; f++) {
                                            var h = M[a >> 2], g = M[a + 4 >> 2]; a += 8; for (var l =
                                                0; l < g; l++) { var k = H[h + l], p = oc[b]; 0 === k || 10 === k ? ((1 === b ? pa : qa)(ya(p, 0)), p.length = 0) : p.push(k) } e += g
                                        } M[d >> 2] = e; return 0
                                    }
                            };
                            (function () {
                                function b(e) { m.asm = e.exports; va = m.asm.M; Ga(); Ha = m.asm.S; Ja.unshift(m.asm.N); Ma--; m.monitorRunDependencies && m.monitorRunDependencies(Ma); 0 == Ma && (null !== Na && (clearInterval(Na), Na = null), Oa && (e = Oa, Oa = null, e())) } function a(e) { b(e.instance) } function c(e) { return Sa().then(function (f) { return WebAssembly.instantiate(f, d) }).then(function (f) { return f }).then(e, function (f) { qa("failed to asynchronously prepare wasm: " + f); ua(f) }) } var d = { a: sc }; Ma++; m.monitorRunDependencies && m.monitorRunDependencies(Ma);
